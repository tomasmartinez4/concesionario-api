...
import { AfterContentInit, AfterViewChecked, AfterViewInit, ElementRef, EventEmitter, NgZone, OnInit, QueryList, Signal, TemplateRef } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { FilterService, OverlayOptions, OverlayService, PrimeTemplate, ScrollerOptions } from 'primeng/api';
...
export declare class MultiSelectItem extends BaseComponent {
    id: string | undefined;
    option: any;
 ...
 * @group Components
 */
export declare class MultiSelect extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    private zone;
...
export declare class MultiSelectModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<MultiSelectModule, never, [typeof MultiSelect, typeof i1.SharedModule], [typeof MultiSelect, typeof i1.SharedModule]>;
