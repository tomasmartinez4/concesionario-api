import { AfterContentInit, AfterViewInit, EventEmitter, OnDestroy, QueryList, SimpleChanges, TemplateRef } from '@angular/core';
...
export declare class ButtonLabel extends BaseComponent {
...
export declare class ButtonIcon extends BaseComponent {
    _componentStyle: ButtonStyle;
 ...
 * @group Components
 */
export declare class ButtonDirective extends BaseComponent implements AfterViewInit, OnDestroy {
    /**
    ...
    private iconSignal;
    private labelSignal;
    isIconOnly: import("@angular/core").Signal<boolean>;
    ...
    isTextButton: import("@angular/core").Signal<boolean>;
    /**
     * Text of the button.
 ...
 * @group Components
 */
export declare class Button extends BaseComponent implements AfterContentInit {
    /**
     * Type of the button.
     * @group Props
     */
    ...
    get buttonClass(): {
        ...
        'p-button-fluid': boolean;
    };
    static ɵfac: i0.ɵɵFactoryDeclaration<Button, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<Button, "p-button", never, { "type": { "alias": "type"; "required": false; }; "iconPos": { "alias": "iconPos"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "badge": { "alias": "badge"; "required": false; }; "label": { "alias": "label"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "loading": { "alias": "loading"; "required": false; }; "loadingIcon": { "alias": "loadingIcon"; "required": false; }; "raised": { "alias": "raised"; "required": false; }; "rounded": { "alias": "rounded"; "required": false; }; "text": { "alias": "text"; "required": false; }; "plain": { "alias": "plain"; "required": false; }; "severity": { "alias": "severity"; "required": false; }; "outlined": { "alias": "outlined"; "required": false; }; "link": { "alias": "link"; "required": false; }; "tabindex": { "alias": "tabindex"; "required": false; }; "size": { "alias": "size"; "required": false; }; "variant": { "alias": "variant"; "required": false; }; "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "badgeClass": { "alias": "badgeClass"; "required": false; }; "badgeSeverity": { "alias": "badgeSeverity"; "required": false; }; "ariaLabel": { "alias": "ariaLabel"; "required": false; }; "autofocus": { "alias": "autofocus"; "required": false; }; "fluid": { "alias": "fluid"; "required": false; }; "buttonProps": { "alias": "buttonProps"; "required": false; }; }, { "onClick": "onClick"; "onFocus": "onFocus"; "onBlur": "onBlur"; }, ["contentTemplate", "loadingIconTemplate", "iconTemplate", "templates"], ["*"], true, never>;
