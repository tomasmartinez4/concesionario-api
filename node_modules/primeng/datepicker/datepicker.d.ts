...
import { AfterContentInit, AfterViewInit, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, QueryList, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class DatePicker extends BaseComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, ControlValueAccessor {
    private zone;
    ...
    get rootClass(): {
        'p-datepicker p-component p-inputwrapper': boolean;
