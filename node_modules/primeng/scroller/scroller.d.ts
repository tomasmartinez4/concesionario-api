import { AfterContentInit, AfterViewChecked, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, QueryList, SimpleChanges, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class Scroller extends BaseComponent implements OnInit, AfterContentInit, AfterViewChecked, OnDestroy {
    private zone;
    /**
